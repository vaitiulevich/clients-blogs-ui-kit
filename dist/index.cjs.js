...
var AuthorDate = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "".concat(textColor, " flex items-center text-sm"), children: [jsxRuntime.jsxs("span", { children: ["By ", jsxRuntime.jsx("span", { className: "".concat(linkColor, " hover:underline"), children: author })] }), jsxRuntime.jsx("span", { className: 'ml-[15px] mr-[7px]', children: "|" }), jsxRuntime.jsx("span", { className: 'ml-2', children: formattedDate })] }));
};
...
var Button = function (_a) {
    ...
    return (jsxRuntime.jsxs("button", __assign({ className: "storybook-button font-sen font-bold ".concat(sizeClasses[size], " ").concat(mode, " outline-none focus:outline-none"), disabled: disabled, type: type }, props, { children: [label, isNavigate && (jsxRuntime.jsx("span", { className: "ml-2", children: jsxRuntime.jsx("img", { src: arrow, alt: "navigate" }) }))] })));
};

var CircleIcon = function (_a) {
    var src = _a.src, alt = _a.alt, className = _a.className;
    return (jsxRuntime.jsx("div", { className: 'rounded-full w-24 h-24 overflow-hidden ', children: jsxRuntime.jsx("img", { src: src, alt: alt, className: "w-24 h-24 object-cover ".concat(className) }) }));
};
...
var ControlledInput = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: 'flex flex-col min-h-16', children: [jsxRuntime.jsx("input", __assign({}, register, { type: type, placeholder: placeholder, disabled: disabled, className: inputClasses })), error && jsxRuntime.jsx("span", { className: 'text-red-500 text-xs', children: error })] }));
};

var LocaleSwitcher = function (_a) {
    var locales = _a.locales, onLocaleChange = _a.onLocaleChange, current = _a.current;
    var _b = react.useState(current), currentLocale = _b[0], setCurrentLocale = _b[1];
    var handleLocaleChange = function (locale) {
        setCurrentLocale(locale);
        onLocaleChange && onLocaleChange(locale);
    };
    return (jsxRuntime.jsx("div", { className: 'relative', children: jsxRuntime.jsx("select", { value: currentLocale, onChange: function (e) { return handleLocaleChange(e.target.value); }, className: 'text-light cursor-pointer bg-darkBG border border-light rounded p-1', children: locales &&
                locales.map(function (locale) { return (jsxRuntime.jsx("option", { className: 'cursor-pointe', value: locale.code, children: locale.label }, locale.code)); }) }) }));
};

var IconButton = function (_a) {
    var icon = _a.icon, _b = _a.disabled, disabled = _b === void 0 ? false : _b, props = __rest(_a, ["icon", "disabled"]);
    return (jsxRuntime.jsx("button", __assign({ type: "button", className: "storybook-button cursor-pointer flex items-center bg-transparent focus:outline-none", disabled: disabled }, props, { children: icon && jsxRuntime.jsx("img", { src: icon.src, alt: icon.alt }) })));
};
...
var SocialIcon = function (_a) {
    ...
    return (jsxRuntime.jsx("img", { src: iconSrc, alt: name, className: "w-4 h-4 ".concat(className) }));
};
...
var Select = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: 'flex flex-col min-h-16', children: [jsxRuntime.jsxs("select", __assign({ value: value }, register, { onChange: onChange, disabled: disabled, className: "border-[0.5px] bg-transparent ".concat(error ? 'border-red-500' : 'border-gray-300', " py-2 px-3 outline-none cursor-pointer"), children: [placeholder && jsxRuntime.jsx("option", { value: '', children: placeholder }), options.map(function (option) { return (jsxRuntime.jsx("option", { value: option.value, children: option.label }, option.value)); })] })), error && jsxRuntime.jsx("span", { className: 'text-red-500 text-xs', children: error })] }));
};
...
var TextArea = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: 'flex flex-col min-h-16 mb-4', children: [jsxRuntime.jsx("textarea", __assign({ value: value, className: "".concat(maxHStyle, " border-[0.5px] bg-transparent ").concat(error ? 'border-red-500' : 'border-gray-300', " py-2 px-3 outline-none cursor-pointer"), onChange: onChange, placeholder: placeholder, disabled: disabled }, register)), error && jsxRuntime.jsx("span", { className: 'text-red-500 text-xs', children: error })] }));
};
